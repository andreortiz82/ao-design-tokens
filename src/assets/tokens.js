...
export const semantic = {
          "component-border-default": "var(--slate-7)","component-base": "var(--white-12)","component-border-secondary": "var(--slate-6)","component-base-subtle": "var(--slate-2)","component-disabled": "var(--slate-5)","component-text-disabled": "var(--slate-8)","component-active": "var(--slate-4)","component-text-default": "var(--slate-12)","component-text-secondary": "var(--slate-11)","component-text-tertiary": "var(--slate-10)","component-text-info": "var(--cyan-9)","component-text-success": "var(--green-9)","component-text-warning": "var(--bright-amber-9)","component-text-danger": "var(--red-9)","component-text-link": "var(--blue-9)","component-text-invert": "var(--white-12)","component-border-tertiary": "var(--slate-5)","component-border-focus": "var(--blue-9)","component-border-active": "var(--blue-9)","component-border-disabled": "var(--slate-5)","component-text-placeholder": "var(--slate-8)"
        }
export const size = {
