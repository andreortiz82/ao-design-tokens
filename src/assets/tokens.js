export const effects = {
          "effects-shadow-lg": "0 10px 15px -3px rgba(0, 0, 0, 0.1),     0 4px 6px -2px rgba(0, 0, 0, 0.05)","effects-shadow-md": "0 4px 6px -1px rgba(0, 0, 0, 0.1),     0 2px 4px -1px rgba(0, 0, 0, 0.06)","effects-shadow-sm": "0 1px 2px 0 rgba(0, 0, 0, 0.05)","effects-shadow-focus": "0px 0px 0px 4px rgba(0, 145, 255, 0.25);"
        }
...
export const semantic = {
          "component-border-default": "var(--slate-7)","component-base": "var(--white-12)","component-border-secondary": "var(--slate-6)","component-base-subtle": "var(--slate-2)","component-disabled": "var(--slate-5)","component-text-disabled": "var(--slate-8)","component-active": "var(--slate-4)","component-text-default": "var(--slate-12)","component-text-secondary": "var(--slate-11)","component-text-tertiary": "var(--slate-10)","component-text-info": "var(--cyan-9)","component-text-success": "var(--green-9)","component-text-warning": "var(--amber-9)","component-text-danger": "var(--red-9)","component-text-link": "var(--blue-9)","component-text-invert": "var(--white-12)","component-border-tertiary": "var(--slate-5)","component-border-focus": "var(--blue-9)","component-border-active": "var(--blue-9)","component-border-disabled": "var(--slate-5)","component-text-placeholder": "var(--slate-8)","component-primary": "var(--slate-12)"
        }
export const size = {
          "size-8": "20px","size-7": "16px","size-6": "12px","size-5-xl": "64px","size-27": "260px","size-3-xl": "48px","size-2-xl": "40px","size-33": "380px","size-xl": "32px","size-6-xl": "72px","size-5": "8px","size-none": "0px","size-0": "0px","size-4": "6px","size-xs": "4px","size-39": "500px","size-25": "220px","size-38": "480px","size-18": "88px","size-40": "520px","size-37": "460px","size-28": "280px","size-36": "440px","size-35": "420px","size-2": "2px","size-sm": "8px","size-3": "4px","size-32": "360px","size-34": "400px","size-31": "340px","size-30": "320px","size-10": "28px","size-md": "16px","size-22": "140px","size-21": "128px","size-12": "40px","size-20": "104px","size-19": "96px","size-26": "240px","size-14": "56px","size-24": "200px","size-9": "24px","size-lg": "24px","size-29": "300px","size-17": "80px","size-16": "72px","size-4-xl": "56px","size-15": "64px","size-13": "48px","size-11": "32px","size-23": "160px","size-1": "1px","size-rounded-none": "0px","size-rounded-full": "1000px","size-rounded-md": "4px","size-rounded-sm": "2px","size-rounded-lg": "8px","size-rounded-lx": "16px"
        }
export const typography = {
          "typography-font-type-system": "Inter, system-ui, Avenir, Helvetica, Arial, sans-serif","typography-font-paragraph-spacing-none": "0","typography-font-letter-spacing-tighter": "0","typography-font-size-3-xl": "33.18000030517578px","typography-font-size-xl": "23.040000915527344px","typography-font-size-lg": "19.200000762939453px","typography-font-size-4-xl": "39.810001373291016px","typography-font-size-5-xl": "47.779998779296875px","typography-font-line-height-none": "0","typography-font-size-sm": "13.329999923706055px","typography-font-h-3": "2rem","typography-font-size-xs": "11.109999656677246px","typography-font-weight-bold": "700","typography-font-rem-9": "2.25rem","typography-font-line-height-tight": "24","typography-font-size-base": "16px","typography-font-rem-7": "1.75rem","typography-font-rem-5": "1.25rem","typography-font-body": "1rem","typography-font-rem-38": "9.5rem","typography-font-rem-22": " 5.5rem","typography-font-rem-35": "8.75rem","typography-font-rem-6": "1.5rem","typography-font-rem-23": "5.75rem","typography-font-rem-31": "7.75rem","typography-font-type-sans": "Inter, system-ui, Avenir, Helvetica, Arial, sans-serif","typography-font-rem-11": "2.75rem","typography-font-rem-30": "7.5rem","typography-font-h-4": "1.5rem","typography-font-rem-4": "1rem","typography-font-rem-3": "0.75rem","typography-font-rem-39": "9.75rem","typography-font-rem-34": "8.5rem","typography-font-rem-24": "6rem","typography-font-rem-28": "7rem","typography-font-rem-1": "0.25rem","typography-font-rem-37": "9.25rem","typography-font-weight-normal": "400","typography-font-rem-25": "6.25rem","typography-font-rem-18": "4.5rem","typography-font-rem-10": "2.5rem","typography-font-rem-19": "4.75rem","typography-font-rem-17": "4.25rem","typography-font-rem-29": "7.25rem","typography-font-h-1": "3rem","typography-font-rem-14": "3.5rem","typography-font-size-2-xl": "27.649999618530273px","typography-font-rem-26": "6.5rem","typography-font-paragraph-indent-none": "0","typography-font-type-serif": "Georgia, Cambria, Times New Roman, Times, serif","typography-font-rem-16": "4rem","typography-font-rem-36": "9rem","typography-font-rem-32": "8rem","typography-font-rem-33": "8.25rem","typography-font-rem-15": "3.75rem","typography-font-rem-20": "5rem","typography-font-caption": "0.75rem","typography-font-footnote": "0.8rem","typography-font-rem-13": "3.25rem","typography-font-rem-27": "6.75rem","typography-font-h-2": "2.5rem","typography-font-h-5": "1.25rem","typography-font-type-code": "Menlo, Monaco, Consolas, Liberation Mono, Courier New,     monospace","typography-font-rem-8": "2rem","typography-font-rem-12": "3rem","typography-font-rem-2": " 0.5rem","typography-font-rem-0": "0","typography-font-rem-21": " 5.25rem"
        }
