...
const As = {
  ...
  Vs = {
    ...
    "component-base": "var(--white-12)",
    "component-border-secondary": "var(--slate-6)",
    "component-base-subtle": "var(--slate-2)",
    "component-disabled": "var(--slate-5)",
    "component-text-disabled": "var(--slate-8)",
    "component-active": "var(--slate-4)",
    "component-text-default": "var(--slate-12)",
    "component-text-secondary": "var(--slate-11)",
    "component-text-tertiary": "var(--slate-10)",
    "component-text-info": "var(--cyan-9)",
    "component-text-success": "var(--green-9)",
    "component-text-warning": "var(--amber-9)",
    "component-text-danger": "var(--red-9)",
    "component-text-link": "var(--blue-9)",
    "component-text-invert": "var(--white-12)",
    ...
    "component-text-placeholder": "var(--slate-8)",
    "component-primary": "var(--slate-12)",
  },
  Bs = {
    "size-8": "20px",
    "size-7": "16px",
